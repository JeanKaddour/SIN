...
def valid_evaluation(model: nn.Module, device, val_loader, epoch: int, val_loss_name: str) -> float:
...
def predict_outcomes(model: nn.Module, device, test_units: List[TestUnit], id_to_graph_dict: dict) -> None:
