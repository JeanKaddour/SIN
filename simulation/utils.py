...
def get_outcome_generator(id_to_graph_dict: dict, args: Namespace) -> Union[None, OutcomeGenerator]:
...
def get_data_generator(task: str, id_to_graph_dict: dict, treatment_assignment_policy: TreatmentAssignmentPolicy,
                       outcome_generator: OutcomeGenerator, in_sample_dataset: Dataset, out_sample_dataset: Dataset,
                       args: Namespace) -> DataGenerator:
    data_generator = None
    if task == 'sw':
...
def create_dataset_dicts(unit_generator, treatment_generator, args: Namespace) -> Tuple[dict, dict, dict]:
