...
from simulation.utils import get_treatment_assignment_policy, get_outcome_generator, get_data_generator, \
    create_dataset
...
if __name__ == "__main__":
    ...
    treatment_assignment_policy = get_treatment_assignment_policy(treatment_ids=all_treatment_ids, args=args)
    outcome_generator = get_outcome_generator(id_to_graph_dict=id_to_graph_dict, args=args)
    data_generator = get_data_generator(task=args.task, id_to_graph_dict=id_to_graph_dict,
