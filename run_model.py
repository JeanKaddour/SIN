...
def parse_default_args():
    ...
    parser.add_argument('--results_path', type=str, default='./results/', help='Path to save experimental results')
...
if __name__ == "__main__":
    ...
    save_run_results(test_units_with_predictions=test_units_with_predictions, test_errors=test_errors,
                     time_str=TIME_STR, args=args)
